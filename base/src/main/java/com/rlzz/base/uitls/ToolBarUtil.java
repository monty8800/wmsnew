...
import com.rlzz.base.R;
import com.rlzz.library.utils.NavigationBarUtil;
import com.rlzz.library.utils.StatusBarUtil;
...
public class ToolBarUtil {
     ...
     * @param resId
     */
    public static void setToolBarSubtitle(Toolbar toolbar, int resId) {
        if (toolbar == null) {
            return;
        }
        toolbar.setSubtitle("");
        TextView titleView = toolbar.findViewById(R.id.toolbar_subTitle);
        if (titleView == null) {
            return;
        }
     ...
     * @param title
     */
    public static void setToolBarSubtitle(Toolbar toolbar, CharSequence title) {
        if (toolbar == null) {
            return;
        }
        toolbar.setSubtitle("");
     ...
     * @param activity
     */
    public static void setToolbarHomeAsUp(AppCompatActivity activity, boolean enable) {
        if (activity == null) {
            return;
        }
